Feature: Attributes management for nodes
    ...
    Scenario: Open the attribute tree
      ...
      Then the "default[test-cookbook][attribute1]" field should contain "value-default-attribute1"

    @javascript
    Scenario: Edit "attribute1"
      When I fill in "default[test-cookbook][attribute1]" with "new attribute1 value"
      When I press "Save node"
      When I open the tree leaf "1" of the "default" panel
      Then the "default[test-cookbook][attribute1]" field should contain "new attribute1 value"
